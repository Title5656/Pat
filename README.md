...
## 🖼️ Message Preview (ตัวอย่างข้อความแจ้งเตือน)
...
## 🏗️ Architecture & Tech Stack (เทคโนโลยีและสถาปัตยกรรม)
...
## ⚙️ Discord Bot Setup & Permissions (การตั้งค่าใน Discord)
...
Project นี้เผยแพร่ภายใต้ [MIT License](LICENSE) ใช้งานและดัดแปลงได้ฟรี 100%
